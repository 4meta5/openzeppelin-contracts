 ...
 */
contract ERC20PresetMinterBurner is Context, AccessControlEnumerable, ERC20Burnable {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC20PresetMinterBurner: must have minter role to mint");
        _mint(to, amount);
    }
    ...
    function burn(address from, uint256 amount) public virtual {
        require(hasRole(BURNER_ROLE, _msgSender()), "ERC20PresetMinterBurner: must have burner role to burn");
        _burn(from, amount);
    }
}
